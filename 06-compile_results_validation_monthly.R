...
for(mnth in 1:12){
    cal.array = array(dim = c(daysinmonth[mnth]*14,7,25))
    for(loc in 1:25){
...
pdf(paste0('plots/means_',region,'_monthly_validation.pdf'),width = 9,height = 4)
...
pdf(paste0('plots/quantiles_',region,'_monthly_validation.pdf'),width = 13,height = 4)
...
pdf(paste0('plots/density_',region,'_seasonal_validation.pdf'),width = 10,height = 4)
